    ...
    public class DailyRewards : DailyRewardsCore<DailyRewards>
    {
        ...
        public void ClaimPrize()
        {
            if (availableReward > 0)
            {
                ...
                if (rewards[availableReward - 1].unit == "Coins")
                    GameManager.instance.UpdateCoins(rewards[availableReward - 1].reward);
                else
                    GameManager.instance.UpdateKeys(rewards[availableReward - 1].reward);
